...
// Claude stage numbering: 1=req, 2=design, 3=clarify, 4=build,
// 4.5a=pre-review, 4.5b=security, 5=peer-review, 6=tests,
// 7=sign-off, 8=deploy, 9=retro
// Gate files use stage-04 style naming.
const REQUIRED = [
  ...
  ["pipeline/pre-review.md", "stage-04a.json"],
  ["pipeline/code-review/by-backend.md", "stage-05-backend.json"],
  ["pipeline/test-report.md", "stage-06.json"],
  ["pipeline/runbook.md", "stage-07.json"],
