...
- `CLAUDE.md`
- `.claude/rules/coding-principles.md` — the four principles are the review rubric
...
- Stage 4.5a: Pre-review (Platform) — lint, tests, dep review, security heuristic
- Stage 4.5b: Security review (Security Engineer) — triggered by heuristic
